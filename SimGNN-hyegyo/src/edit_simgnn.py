...
class Student(torch.nn.Module): 
    def __init__(self, args, number_of_labels,device):
        ...
        self.convolution_1 = GCNConv(number_of_labels, self.args.filters_3)
...
class SimGNN(torch.nn.Module):
    ...
    def forward(self, data):
        ...
        features_1 = data["features_1"].to(self.device)
        features_2 = data["features_2"].to(self.device)
        # print(f'features:{features_1.shape}, features2:{features_2.shape},edge_index:{edge_index_1.shape} edge_index2:{edge_index_2.shape}')
